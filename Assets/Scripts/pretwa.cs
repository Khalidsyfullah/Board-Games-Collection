...
public class pretwa : MonoBehaviour
{
    ...
    //change
    GameObject[] grid_board = new GameObject[19];
    int[] grid_position = new int[19];
    ...
    //change
    int[,] grid_connector_secondary = { {-100, -1, 1, -1, -100, -100, 3, -100, -100, -1, -100, -100, 9, -100, -100, -100, -100, -100, -100 },
                                        {-1, -100, -1, -100, -1, -100, -100, 4, -100, -100, -1, -100, -100, 10, -100, -100, -100, -100, 2 },
                                        {1, -1, -100, -100, -100, -1, -100, -100, 5, -100, -100, -1, -100, -100, 11, -100, -100, 18, -1 },
                                        {-1, -100, -100, -100, -1, 4, -1, -100, -100, 0, -100, -100, -100, -100, -100, 6, -100, -100, -100 },
                                        {-100, -1, -100, -1, -100, -1, -100, -1, -100, -100, 1, -100, -100, -100, -100, -100, 7, -100, 5 },
                                        {-100, -100, -1, 4, -1, -100, -100, -100, -1, -100, -100, 2, -100, -100, 18, -100, -100, 8, -1 },
                                        {3, -100, -100, -1, -100, -100, -100, -1, 7, -100, -100, -100, 15, -100, -100, -1, -100, -100, -100 },
                                        {-100, 4, -100, -100, -1, -100, -1, -100, -1, -100, -100, -100, -100, 16, -100, -100, -1, -100, 8 },
                                        {-100, -100, 5, -100, -100, -1, 7, -1, -100, -100, -100, 18, -100, -100, 17, -100, -100, -1, -1 },
                                        {-1, -100, -100, 0, -100, -100, -100, -100, -100, -100, -1, 10, -1, -100, -100, 12, -100, -100, -100 },
                                        {-100, -1, -100, -100, 1, -100, -100, -100, -100, -1, -100, -1, -100, -1, -100, -100, 13, -100, 11 },
                                        {-100, -100, -1, -100, -100, 2, -100, -100, 18, 10, -1, -100, -100, -100, -1, -100, -100, 14, -1 },
                                        {9, -100, -100, -100, -100, -100, 15, -100, -100, -1, -100, -100, -100, -1, 13, -1, -100, -100, -100 },
                                        {-100, 10, -100, -100, -100, -100, -100, 16, -100, -100, -1, -100, -1, -100, -1, -100, -1, -100, 14 },
                                        {-100, -100, 11, -100, -100, 18, -100, -100, 17, -100, -100, -1, 13, -1, -100, -100, -100, -1, -1 },
                                        {-100, -100, -100, 6, -100, -100, -1, -100, -100, 12, -100, -100, -1, -100, -100, -100, -1, 16, -100 },
                                        {-100, -100, -100, -100, 7, -100, -100, -1, -100, -100, 13, -100, -100, -1, -100, -1, -100, -1, 17 },
                                        {-100, -100, 18, -100, -100, 8, -100, -100, -1, -100, -100, 14, -100, -100, -1, 16, -1, -100, -1 },
                                        {-100, 2, -1, -100, 5, -1, -100, 8, -1, -100, 11, -1, -100, 14, -1, -100, 17, -1, -100 }};
    ...
    void Start()
    {
        ...
        string name = "Artboard 1sholo guti_0";
        ...
        settings = PlayerPrefs.GetInt("Laukatakati", 1);
    ...
    void u1()
    {
        for (int i = 0; i < grid_board.Length; i++)
        {
            if (grid_connector_secondary[count, i] == -1)
            {
                grid_board[i].GetComponent<SpriteRenderer>().sprite = gutis[0];
            }
        }
    }
    ...
    void u2()
    {
        for (int i = 0; i < grid_board.Length; i++)
        {
            if (grid_connector_secondary[dcount, i] >= 0)
            {
                grid_board[i].GetComponent<SpriteRenderer>().sprite = gutis[0];
                grid_board[grid_connector_secondary[dcount, i]].GetComponent<SpriteRenderer>().sprite = gutis[1];
            }
        }
    }
    ...
    void Update()
    {
        if (Input.GetMouseButtonDown(0))
        {
            for (int i = 0; i < grid_board.Length; i++)
            {
                grid_board[i].GetComponent<SpriteRenderer>().sprite = null;
            }
